...
class AssistantWidgetSessionEndpointsTests(TestCase):
    ...
    def test_widget_chat_response_does_not_expose_debug_trace_or_processing_details(self):
        self.client.login(username=self.user.username, password=self.password)
        ...
        self.assertNotIn("processing_statuses", payload)
        self.assertNotIn("processing_status", payload)
