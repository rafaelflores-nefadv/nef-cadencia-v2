...
ASSISTANT_SUPPORTED_QUERY_SUMMARY = (
    "consultar quem esta em pausa agora, ranking de pausas por data, resumo operacional diario e analytics de produtividade ou improdutividade por periodo"
)
...
ASSISTANT_SCOPE_ALLOWED_PATTERNS = (
    r"\b(quem|quais|mostre|mostrar|liste|listar|resuma|resumo|top|ranking|tem|vejo|ver)\b.*\b"
    r"(pausas?|agentes?|operadores?|eventos?|relatorios?|dashboard|indicadores?|"
