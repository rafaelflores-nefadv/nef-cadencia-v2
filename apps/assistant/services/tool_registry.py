...
TOOL_GET_AGENTS_LISTING = "get_agents_listing"
...
def get_tools_schema() -> list[dict]:
    return [
        {
            "type": "function",
            "name": TOOL_GET_AGENTS_LISTING,
            "description": (
                "Retorna agentes cadastrados no sistema, com opcao de filtrar apenas ativos."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "only_active": {
                        "type": "boolean",
                        "description": "Quando true, lista somente agentes ativos.",
                    },
                    "search": {
                        "type": "string",
                        "description": "Filtro opcional por nome, codigo, e-mail ou codigo do operador.",
                    },
                    "limit": {
                        "type": "integer",
                        "description": "Quantidade maxima de agentes retornados.",
                        "default": 50,
                    },
                },
                "required": [],
        ...
        },
        {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "only_active": {
                        "type": "boolean",
                        "description": "Quando true, considera apenas agentes ativos no ranking.",
                    },
                    "limit": {
                        "type": "integer",
...
def execute_tool(name: str, args: dict, user) -> dict:
    ...
    args = args or {}
    if name == TOOL_GET_AGENTS_LISTING:
        return get_agents_listing(
            only_active=args.get("only_active"),
