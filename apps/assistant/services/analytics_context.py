...
def apply_productivity_context_to_tool_args(tool_args: dict, raw_context) -> tuple[dict, bool]:
...
def format_productivity_context_instruction(raw_context) -> str | None:
    productivity_context = get_productivity_context(raw_context)
    if productivity_context is None:
        return None
